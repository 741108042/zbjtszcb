...
class ProjectController extends Controller
{
    ...
    */
     ...
     * Edits an existing Project entity.
     *
     * @Route("/preview/{id}", name="project_preview")
     * @Template("AppBundle:Project:preview.html.twig")
     */
    public function previewAction(Request $request,$id){
        ...
        $pages=$em->getRepository('AppBundle:Page')->createQueryBuilder('p')
            ->where('p.projectId='.$id)->getQuery()->getArrayResult();
        foreach($pages as $ind=>$page){
            $pages[$ind]['items']=array();
            $items=$em->getRepository('AppBundle:PageItem')->findBy(array('pageid'=>$page['id']));
            foreach($items as $item):
                $content=json_decode($item->getContent(),true);
                $pages[$ind]['items'][]='<div class="ani"  swiper-animate-effect="'.$content['ani'].
